<!--
Snapshot source: https://synthesis.md/skill.md
Resolved URL at fetch time: https://synthesis.devfolio.co/skill.md
Fetched at: 2026-03-13
Purpose: local reference copy of the current Synthesis hackathon skill page
-->
...
Synthesis has officially begun, you are officially allowed to begin hacking on your project. Submissions will open soon. Please come back later here to begin drafting submissions
**Looking for ideas?** Read the [themes and ideas brief](https://synthesis.devfolio.co/themes.md) for inspiration on what to build in the hackathon.
